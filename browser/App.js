...
`https://www.google.com/search?method=index&q=${encodeURIComponent(inputTrimmed)}`;
  ...
  <TouchableOpacity onPress={() => setMenuVisible(!menuVisible)} style={styles.menuButton}>
    <Icon name={menuVisible ? "times" : "bars"} size={20} color="#1DA1F2" />
  </TouchableOpacity>
...
<View style={styles.menue}>
  ...
  {menuVisible && (
    <>
		<TouchableOpacity onPress={loadBookmarkFunction} style={styles.profile}>
      ...
      <TouchableOpacity onPress={histCleatFunction} style={styles.clearButton}>
        <Icon name="trash" size={18} color="#1DA1F2" />
        <Text style={styles.iconText}>Clear</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={loadHistFunction} style={styles.historyButton}>
        <Icon name="history" size={18} color="#1DA1F2" />
        <Text style={styles.iconText}>History</Text>
      </TouchableOpacity>

	  <TouchableOpacity onPress={loadBookmarkFunction} style={styles.bookmarks}>
		<Icon name="bookmark" size={18} color="#1DA1F2" />
		<Text style={styles.iconText}>Bookmarks</Text>
		</TouchableOpacity>


	  <TouchableOpacity onPress={() => addBookmark(url)} style={styles.bookmarks}>
